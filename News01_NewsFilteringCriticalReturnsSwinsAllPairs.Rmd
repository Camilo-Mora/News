...
PerCorrection=0.5 #Percent of correction tested. This is used to calcualte zigzag of this size of large. Basically, times when market extended before having a correction of this size
...
PlotFilteringNews <- function(Ticker, Date,Change,News, CriticalThreshold, YHover, YAxisName, ExcludeFreqNewsAbovePerc){
        ...
        ListOfCriticalNews =ListOfCriticalNews %>% distinct(Name, currency)
        ListOfCriticalNews <- ListOfCriticalNews[complete.cases(ListOfCriticalNews), ] 
...
#compile list of crtiical news by each pair...given both citical retruns and swings
    NameCriticalNewsReturns=data.frame(rbind(Returns[[3]],Swings[[3]]))
    NameCriticalNewsReturns =NameCriticalNewsReturns %>% distinct(Name, currency) #slect uniques
...
colnames(CriticalNewsByPair_Returns)=c("Pair", "Event", "Currency")
write.csv(CriticalNewsByPair_Returns, "News01_CriticalNews_ListByPair_ReturnsAndSwing.csv")

colnames(CriticalNewsByPair_SwinsOnly)=c("Pair", "Event", "Currency")
